...
const useStyles = makeStyles((theme: Theme) =>
  createStyles({
    textarea: {
      width: '100%',
      border: `solid 1px ${
        theme.palette.type === 'dark' ? grey[700] : 'lightgrey'
      }`,
      outline: 'none',
...
const StyledTextareaAutosize = React.forwardRef<
  HTMLTextAreaElement,
  TextAreaProps
>(function StyledTextareaAutosize(props: TextAreaProps, ref) {
